...
namespace Gyoji::frontend::namespaces {
	...
	friend Gyoji::frontend::namespaces::NamespaceContext;
    protected:
	/////////////////////////////
	...
	std::map<std::string, Gyoji::owned<Namespace>> children;  // This is the list of child namespaces.
	 ...
	 * Gyoji built-in primitive types such as 'u8', 'u32', 'i32',
